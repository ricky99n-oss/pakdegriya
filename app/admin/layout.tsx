    ...
    <div className="min-h-screen flex bg-[#FFF7E8]">
      ...
      <aside className="w-72 bg-[#4A2F1B] text-white flex flex-col shadow-2xl z-10">
        ...
        <div className="p-8 flex items-center gap-4 border-b border-white/10">
          <div className="w-10 h-10 rounded-xl bg-[#D6A34A] flex items-center justify-center text-[#4A2F1B] font-bold text-xl shadow-lg">
            P
          </div>
          <div>
        ...
        <nav className="flex-1 p-6 space-y-2">
          ...
          {/* Menu Aktif (Bisa dibikin dinamis nanti, sementara kita hardcode aktif di Properti) */}
        ...
        {/* Profil Bawah */}
        <div className="p-6">
          <div className="p-4 rounded-2xl bg-black/20 backdrop-blur-sm border border-white/10 flex items-center gap-3">
