    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FFF7E8] p-4 md:p-6 font-sans text-[#281C15]">
      <div className="max-w-5xl w-full bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row-reverse border border-[#D6A34A]/20">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input type="text" name="name" required className="w-full border border-gray-200 p-3.5 rounded-xl bg-gray-50 focus:outline-none focus:border-[#D6A34A] focus:ring-2 focus:ring-[#D6A34A]/20 transition-all text-[#281C15]" placeholder="Cth: Budi Santoso" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" name="password" required minLength={6} className="w-full border border-gray-200 p-3.5 rounded-xl bg-gray-50 focus:outline-none focus:border-[#D6A34A] focus:ring-2 focus:ring-[#D6A34A]/20 transition-all text-[#281C15]" placeholder="Minimal 6 karakter" />
            </div>
        ...
        <div className="hidden md:block w-full md:w-1/2 relative bg-[#4A2F1B]">
          <Image src="/images/pakde-2.webp" alt="Daftar Member Pakde Griya" fill className="object-cover opacity-60 mix-blend-luminosity hover:scale-105 transition-transform duration-1000" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#4A2F1B] via-[#4A2F1B]/40 to-transparent flex flex-col justify-end p-12">
            <h2 className="text-4xl font-black text-white mb-3">Bergabung Bersama <span className="text-[#D6A34A]">Kami</span></h2>
            <p className="text-white/80 text-base leading-relaxed font-medium">Rasakan pengalaman survei properti tanpa batas dan temukan investasi terbaik di Dunia bersama Pakde Griya.</p>
          </div>
        </div>
